...
def word_to_num(number_sentence):
    ...
    if len(clean_numbers) == 0:
        raise ValueError("No valid number words found! Please enter a valid number word (eg. two million twenty "
                         "three thousand and forty nine)")

    # Error if user enters million,billion, thousand or decimal point twice
    if clean_numbers.count('thousand') > 1 \
            or clean_numbers.count('million') > 1 \
            or clean_numbers.count('billion') > 1 \
    ...
    if (thousand_index > -1 and (thousand_index < million_index or thousand_index < billion_index)) \
        ...
        raise ValueError("Malformed number! Please enter a valid number word (eg. two million twenty three "
                         "thousand and forty nine)")
